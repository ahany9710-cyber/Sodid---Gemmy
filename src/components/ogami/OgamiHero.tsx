...
const OgamiHero = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-black/55 via-black/45 to-black/90" aria-hidden />
      <div className={`absolute inset-0 ${sideVignette}`} aria-hidden />

      <div className="relative z-10 flex min-h-[100svh] items-end pb-16 pt-24 md:pb-24 md:pt-28">
        <div className="mx-auto w-full max-w-7xl px-6 md:px-10 lg:px-12">
          <div className="max-w-3xl">
            ...
            <h1
              className={`${fontClass} text-4xl font-bold leading-[1.08] text-white drop-shadow-[0_3px_10px_rgba(0,0,0,0.55)] sm:text-5xl md:text-6xl lg:text-7xl`}
            >
              {h.h1Main}
              <span className="mt-1 block text-xl font-semibold text-white sm:text-2xl md:text-3xl lg:text-4xl">
                {h.h1Sub}
              </span>
            </h1>
            ...
            <div className="mt-7 grid max-w-lg grid-cols-2 gap-2 text-white sm:gap-3">
              <div className="border border-white/25 bg-white/5 px-3 py-3 backdrop-blur-sm sm:px-4">
                <p className="text-[10px] font-semibold uppercase tracking-wider text-white/85 line-clamp-2">
                  {h.card1Label}
                </p>
            ...
            <p
              className={`${fontClass} mt-5 max-w-xl text-xs text-white drop-shadow-[0_1px_4px_rgba(0,0,0,0.6)] md:text-sm`}
            >
              {h.footnote}
            </p>
          </div>
